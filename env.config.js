...
export const WORKING_DIR = (processEnv.WORKING_DIR ||
  join(CONTENT_PATH_PREFIX, CONTENT_DIR))

// WORKING_DIR_ABSOLUTE properly concatenate CONTENT_PATH_PREFIX and CONTENT_DIR
export const WORKING_DIR_ABSOLUTE = processEnv.WORKING_DIR_ABSOLUTE ||
...
export const VERCEL_GIT_REPO_OWNER = processEnv.VERCEL_GIT_REPO_OWNER || processEnv.VERCEL_GIT_REPO_OWNER;
export const VERCEL_GIT_REPO_SLUG = processEnv.VERCEL_GIT_REPO_SLUG || processEnv.VERCEL_GIT_REPO_SLUG;
