...
L'affiche a été retenue parmi 15 propositions. À partir de celle-ci, nous avons décliné l’identité visuelle pour l’ensemble de la communication du spectacle, joué notamment au {% link url="https://www.lejacquesfranck.be/", type="external" %}Centre culturel Jacques Franck{% endlink %} à Saint-Gilles.
...
Affiche · flyers · identité visuelle · direction artistique · retouche d’image · déclinaison sur supports de communication
